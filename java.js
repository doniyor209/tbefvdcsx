...
// console.log(harflar[0]+harflar[11]+harflar[7]+harflar[16]+harflar[21]);

// let harflar = ["a" , "b" , "d" , "e" , "f" , "g" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "o" , "p" , "q" , "r" , "s" , "t",  "u" , "v" , "x" , "y" , "z" ]

// console.log(harflar[2]+harflar[13]+harflar[12]+harflar[7]+harflar[22]+harflar[13]+harflar[16]);
...
// if (a > "18") {
//     alert("Siz balag'ot yoshiga yetgansiz , aks holda  siz balog'at yoshiga yetmagansizz");
// }
...
// h1.textContent=a;
// h2.textContent=b;
// h1.style =("color:green; font-size:50px;text-align:center;")
// h2.style =("color:green; font-size:50px;text-align:center;")
